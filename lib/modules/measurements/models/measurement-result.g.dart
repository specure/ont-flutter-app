...
MeasurementResult _$MeasurementResultFromJson(Map<String, dynamic> json) =>
    MeasurementResult(
      ...
      bytesDownload: (json['test_bytes_download'] as num).toInt(),
      bytesUpload: (json['test_bytes_upload'] as num).toInt(),
      nsecDownload: (json['test_nsec_download'] as num).toInt(),
      nsecUpload: (json['test_nsec_upload'] as num).toInt(),
      totalDownloadBytes: (json['test_total_bytes_download'] as num).toInt(),
      totalUploadBytes: (json['test_total_bytes_upload'] as num).toInt(),
      speedDownload: (json['test_speed_download'] as num).toDouble(),
      speedUpload: (json['test_speed_upload'] as num).toDouble(),
      pingShortest: (json['test_ping_shortest'] as num).toInt(),
      serverIpAddress: json['test_ip_server'] as String,
      localIpAddress: json['test_ip_local'] as String,
      testNumThreads: (json['test_num_threads'] as num).toInt(),
      testPortRemote: (json['test_port_remote'] as num).toInt(),
      ...
      networkType: (json['network_type'] as num?)?.toInt(),
      packetLoss:
