...
class MockMapSearchApiService extends _i1.Mock
  ...
  _i4.Future<List<_i5.MapSearchItem>> search(_i6.MapSearchRequest? request) =>
      (super.noSuchMethod(
            ...
            returnValue: _i4.Future<List<_i5.MapSearchItem>>.value(
              <_i5.MapSearchItem>[],
            ),
          )
...
class MockTechnologyApiService extends _i1.Mock
  ...
  @override
  _i4.Future<List<String>> getMnoProviders() =>
      (super.noSuchMethod(
            Invocation.method(#getMnoProviders, []),
  ...
  @override
  _i4.Future<List<String>> getIspProviders() =>
      (super.noSuchMethod(
            Invocation.method(#getIspProviders, []),
            returnValue: _i4.Future<List<String>>.value(<String>[]),
            returnValueForMissingStub: _i4.Future<List<String>>.value(
              <String>[],
            ),
