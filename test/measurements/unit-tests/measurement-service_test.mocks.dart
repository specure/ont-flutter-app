...
// in nt_flutter_standalone/test/measurements/unit-tests/measurement-service_test.dart.
...
class MockPingWrapper extends _i1.Mock implements _i7.PingWrapper {
  ...
  @override
  _i8.Ping? getIstance(String? host, {int? count, double? intervalS}) =>
      (super.noSuchMethod(
            Invocation.method(
              #getIstance,
              [host],
              {#count: count, #intervalS: intervalS},
            ),
          )
          as _i8.Ping?);
}
