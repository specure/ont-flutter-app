...
import com.specure.nt_flutter_standalone.utils.extensions.isCoarseLocationPermitted
import com.specure.nt_flutter_standalone.utils.extensions.isPreciseLocationPermitted
...
class LocationAccessImpl(private val context: Context) : LocationAccess {
    ...
    val isPreciseLocationAllowed: Boolean
        get() = context.isPreciseLocationPermitted()
